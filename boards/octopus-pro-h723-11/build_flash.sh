...
#  exit
#fi
MCU=/dev/serial/by-id/usb-Klipper_stm32h723xx_3E001A001051313531383332-if00
cp -f ~/printer_data/config/boards/octopus-pro-h723-11/firmware.config  ~/klipper/.config
pushd ~/klipper
make olddefconfig
make clean
